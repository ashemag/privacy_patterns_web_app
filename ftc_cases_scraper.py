...
'''
SCRIPT FOR SCRAPING FTC WEBSITE TO OBTAIN CASE DATA 

1. Collected Case Name, Case URL, Case Number, Last Updated, Tags
2. Visualized tag data 
3. TODO: Update when new cases should be added, for deployment run abbreviated version in background 
...
#chart visualization for blog post 
