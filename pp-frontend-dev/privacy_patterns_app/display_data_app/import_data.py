...
Django Database 
'''
privacy_principles_csv = 'display_data_app/privacy_principles.csv'
class Importer: 

	def __init__(self, cases_csv = 'display_data_app/opc_cases.csv'): 
	...
	def populate_database(self, REPLACE=False, OPC=True):
